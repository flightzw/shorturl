...
type Data struct {
	...
	Shorturl *Data_Shorturl `protobuf:"bytes,4,opt,name=shorturl,proto3" json:"shorturl,omitempty"`
}
...
func (x *Data) GetShorturl() *Data_Shorturl {
	if x != nil {
		return x.Shorturl
	}
	return nil
...
func (x *Data_Shorturl) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Shorturl) ProtoMessage() {}

func (x *Data_Shorturl) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Shorturl.ProtoReflect.Descriptor instead.
func (*Data_Shorturl) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{2, 3}
}

func (x *Data_Shorturl) GetUrlPrefix() string {
	if x != nil {
		return x.UrlPrefix
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xab, 0x04, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61,
	...
	0x52, 0x07, 0x6d, 0x6f, 0x6e, 0x67, 0x6f, 0x64, 0x62, 0x12, 0x35, 0x0a, 0x08, 0x73, 0x68, 0x6f,
	0x72, 0x74, 0x75, 0x72, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6b, 0x72,
	0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x53, 0x68,
	0x6f, 0x72, 0x74, 0x75, 0x72, 0x6c, 0x52, 0x08, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x75, 0x72, 0x6c,
	...
	,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Data_Shorturl)(nil),       // 8: kratos.api.Data.Shorturl
...
var file_conf_conf_proto_depIdxs = []int32{
	...
	8,  // 7: kratos.api.Data.shorturl:type_name -> kratos.api.Data.Shorturl
